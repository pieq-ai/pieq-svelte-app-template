...
function readId(record: Record<string, unknown>, master: MasterKey): bigint {
	return BigInt(record[getMasterConfig(master).idField] as string | number | bigint | boolean);
}
