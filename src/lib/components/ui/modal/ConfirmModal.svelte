	...
	>
		...
		>
			...
			<div class="flex items-center justify-end gap-3">
				<Button
					type="button"
					variant={(cancelLabel === 'Continue Editing' || cancelLabel === 'Cancel' || cancelLabel === 'Keep Editing') ? 'outline' : 'ghost'}
				...
				<Button
					...
					class={(confirmLabel === 'Close Without Saving' || confirmLabel === 'Delete' || confirmLabel === 'Cancel' || confirmLabel === 'Keep Editing') ? 'bg-[#800020] text-white hover:bg-[#800020]/90 border-none font-semibold' : ''}
