...
<div bind:this={triggerContainer} class="relative w-full">
	...
	<div class="relative flex items-center">
		...
		<input
			...
			class={cn(
				"dark:bg-input/30 border-input focus-visible:border-input-focus focus-visible:ring-input-focus-ring aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 h-9 rounded-md border bg-transparent pl-10 pr-2.5 py-1 text-base shadow-xs transition-[color,box-shadow] focus-visible:ring-4 md:text-sm file:text-foreground placeholder:text-muted-foreground w-full min-w-0 outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 select-text",
