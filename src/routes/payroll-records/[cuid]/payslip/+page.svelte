<script lang="ts">
	...
	// ─── Deduction keyword detection ──────────────────────────────────────────────
	// Since all breakdown values may be stored as positive numbers, we classify
	// components by name rather than sign. Known deduction patterns take priority.
	...
	function isDeductionComponent(name: string): boolean {
	...
	let netPayWords = $derived(numberToWords(payroll.net_salary));
