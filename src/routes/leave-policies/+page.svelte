		...
		<Card>
			<Table>
				<TableHeader>
					<TableRow>
						<TableHead>
							<Button variant="ghost" size="sm" class="-ml-2.5 h-8" onclick={() => handleSort('leave_type_cuid')}>
								Leave Type
						...
						<TableHead>
							<Button variant="ghost" size="sm" class="-ml-2.5 h-8" onclick={() => handleSort('employment_type_cuids')}>
								Employment Types
						...
						<TableHead class="w-24 text-right">
							<Button variant="ghost" size="sm" class="-mr-2.5 h-8 ml-auto" onclick={() => handleSort('annual_limit')}>
								Annual Limit
						...
						<TableHead class="w-24 text-center">
							<Button variant="ghost" size="sm" class="h-8" onclick={() => handleSort('carry_forward_allowed')}>
								Carry Fwd
						...
						<TableHead class="w-24 text-center">
							<Button variant="ghost" size="sm" class="h-8" onclick={() => handleSort('allow_half_day')}>
								Half Day
						...
						<TableHead class="w-24 text-center">
							<Button variant="ghost" size="sm" class="h-8" onclick={() => handleSort('gender_specific')}>
								Gender
...
>
	{#snippet children({ cancel })}
		<form method="POST" action="" onsubmit={handleSubmit} class="flex flex-col min-h-0 flex-1 overflow-hidden" novalidate>
			...
			<!-- Leave Type Dropdown -->
			<div class="space-y-2">
				<Label for="modal_leave_type_cuid" class={errors.leave_type_cuid ? 'text-danger' : ''}>Leave Type <span class="text-destructive">*</span></Label>
				<input type="hidden" id="modal_leave_type_cuid" name="leave_type_cuid" value={leaveTypeId} />
				<DropdownMenu.Root>
					<DropdownMenu.Trigger>
						{#snippet child({ props })}
							<Button variant="outline" class="h-9 w-full justify-between border-input bg-background px-3 text-sm font-normal shadow-xs hover:bg-accent focus:border-ring focus:ring-ring/50 focus:ring-3 data-[state=open]:border-ring data-[state=open]:ring-ring/50 data-[state=open]:ring-3 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-3 transition-[color,box-shadow] outline-none {errors.leave_type_cuid ? 'border-danger focus:border-danger focus:ring-danger/30 focus-visible:ring-danger/30 data-[state=open]:border-danger data-[state=open]:ring-danger/30' : ''}" {...props}>
				...
				{#if errors.leave_type_cuid}
					<p class="text-xs font-medium text-danger mt-1">{errors.leave_type_cuid}</p>
				{/if}
			</div>

			<!-- Employment Types -->
			<div class="space-y-2">
				<Label class={errors.employment_type_cuids ? 'text-danger' : ''}>Applicable Employment Types <span class="text-destructive">*</span></Label>
				<MultiSelect
				...
				/>
				{#if errors.employment_type_cuids}
					<p class="text-xs font-medium text-danger mt-1">{errors.employment_type_cuids}</p>
				{/if}
			</div>

			<div class="space-y-2">
				<Label for="modal_annual_limit" class={errors.annual_limit ? 'text-danger' : ''}>Annual Limit (Days) <span class="text-destructive">*</span></Label>
				<Input
					...
					required
					class={errors.annual_limit ? 'border-danger focus-visible:ring-danger/30' : ''}
				/>
				{#if errors.annual_limit}
					<p class="text-xs font-medium text-danger mt-1">{errors.annual_limit}</p>
				{/if}
			</div>

			<div class="space-y-2">
				<Label for="modal_max_per_month" class={errors.max_per_month ? 'text-danger' : ''}>Max Per Month (Optional)</Label>
				<Input
					...
					placeholder="e.g. 2"
					class={errors.max_per_month ? 'border-danger focus-visible:ring-danger/30' : ''}
				/>
				{#if errors.max_per_month}
					<p class="text-xs font-medium text-danger mt-1">{errors.max_per_month}</p>
				{/if}
			</div>
			...
			{#if carryForwardAllowed}
				<div transition:slide class="space-y-2 pl-4">
					<Label for="modal_max_carry_forward_days" class={errors.max_carry_forward_days ? 'text-danger' : ''}>Max Carry Forward Days <span class="text-destructive">*</span></Label>
					<Input
						...
						class={errors.max_carry_forward_days ? 'border-danger focus-visible:ring-danger/30' : ''}
					/>
					{#if errors.max_carry_forward_days}
						<p class="text-xs font-medium text-danger mt-1">{errors.max_carry_forward_days}</p>
					{/if}
				</div>
			{/if}
			...
			{#if documentRequired}
				<div transition:slide class="space-y-2 pl-4">
					<Label for="modal_document_required_after_days" class={errors.document_required_after_days ? 'text-danger' : ''}>Document Required After Days</Label>
					<Input
						...
						class={errors.document_required_after_days ? 'border-danger focus-visible:ring-danger/30' : ''}
					/>
					{#if errors.document_required_after_days}
						<p class="text-xs font-medium text-danger mt-1">{errors.document_required_after_days}</p>
					{/if}
				</div>
			{/if}
			...
			{#if genderSpecific}
				<div transition:slide class="space-y-2 pl-4">
					<Label for="modal_applicable_gender" class={errors.applicable_gender ? 'text-danger' : ''}>Applicable Gender <span class="text-destructive">*</span></Label>
					<input type="hidden" id="modal_applicable_gender" name="applicable_gender" value={applicableGender} />
					<DropdownMenu.Root>
						<DropdownMenu.Trigger>
							{#snippet child({ props })}
								<Button variant="outline" class="h-9 w-full justify-between border-input bg-background px-3 text-sm font-normal shadow-xs hover:bg-accent focus:border-ring focus:ring-ring/50 focus:ring-3 data-[state=open]:border-ring data-[state=open]:ring-ring/50 data-[state=open]:ring-3 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-3 transition-[color,box-shadow] outline-none {errors.applicable_gender ? 'border-danger focus:border-danger focus:ring-danger/30 focus-visible:ring-danger/30 data-[state=open]:border-danger data-[state=open]:ring-danger/30' : ''}" {...props}>
					...
					{#if errors.applicable_gender}
						<p class="text-xs font-medium text-danger mt-1">{errors.applicable_gender}</p>
					{/if}
				</div>
			{/if}
			...
			<!-- Min Service Days -->
			<div class="space-y-2">
				<Label for="modal_min_service_days" class={errors.min_service_days ? 'text-danger' : ''}>Min Service Days (Active service req.) <span class="text-destructive">*</span></Label>
				<Input
					...
					placeholder="e.g. 90"
					class={errors.min_service_days ? 'border-danger focus-visible:ring-danger/30' : ''}
				/>
				{#if errors.min_service_days}
					<p class="text-xs font-medium text-danger mt-1">{errors.min_service_days}</p>
				{/if}
			</div>
			...
			<div class="pb-2">
				...
				/>
				{#if errors.status}
					<p class="text-xs font-medium text-danger mt-1">{errors.status}</p>
				{/if}
			</div>
...
>
	{#snippet children({ cancel })}
		<form class="flex flex-col min-h-0 flex-1 overflow-hidden" onsubmit={handleAddEmploymentType}>
			<div class="flex-1 overflow-y-auto pr-1 space-y-4 modal-scroll-area">
				<div class="space-y-2">
					<Label for="new_emp_name" class={newEmpError ? 'text-danger' : ''}>Employment Type Name <span class="text-destructive">*</span></Label>
					<Input
						id="new_emp_name"
						bind:value={newEmpName}
						class={newEmpError ? 'border-danger focus-visible:ring-danger/30' : ''}
						placeholder="e.g. Contract, Part-Time"
						oninput={() => { newEmpError = ''; }}
					/>
					{#if newEmpError}
						<p class="text-xs font-medium text-danger mt-1">{newEmpError}</p>
					{/if}
				</div>
			</div>
