...
## Corpus Check
- 339 files · ~115,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1395 nodes · 2663 edges · 93 communities (77 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b245676`
...
6. `$lib/components/employee/EmployeeWizard.svelte` - 21 edges
...
Cohesion: 0.05
Nodes (73): GET(), POST(), GET(), POST(), createSuccessResponse(), deleteSuccessResponse(), EmploymentTypeDTO, EmploymentTypeInput (+65 more)
...
Cohesion: 0.10
Nodes (26): GET(), MasterCreateInput, MasterUpdateInput, getMasterConfig(), isMasterKey(), MasterConfig, masterConfigs, MasterKey (+18 more)
...
Cohesion: 0.13
Nodes (17): getMaster(), POST(), POST(), POST(), GET(), PUT(), GET(), PUT() (+9 more)
...
Cohesion: 0.08
Nodes (7): UpsertDocumentInput, CreateEmployeeInput, remove(), update(), UpdateEmployeeInput, documentSchema, UpsertDocumentDto
...
Cohesion: 0.13
Nodes (21): ./$types, load(), load(), findByEmployeeCuid(), upsert(), UpsertEmploymentInput, load(), employmentSchema (+13 more)
...
Cohesion: 0.15
Nodes (9): UpsertAddressInput, UpsertSkillInput, createEmployee(), CreateEmployeeDto, deleteEmployee(), generateNextEmployeeCode(), toPublicEmployee(), updateEmployee() (+1 more)
...
Cohesion: 0.09
Nodes (8): CreatePermissionInput, UpdatePermissionInput, CreateSystemRoleInput, UpdateSystemRoleInput, assignPermissionsToRole(), AssignRolePermissionsDto, removePermissionFromRoleByCuid2(), validateCuid2()

### Community 59 - "Community 59"
Cohesion: 0.09
Nodes (8): UpsertLanguageInput, CreateLeavePolicyData, update(), CreateRolePermissionInput, createClient(), db, getDb(), isValidClient()
...
## Knowledge Gaps
- **307 isolated node(s):** `css.lint.unknownAtRules`, `$schema`, `css`, `baseColor`, `components` (+302 more)
...
- **Why does `db` connect `Community 59` to `Community 32`, `Community 33`, `Community 1`, `Community 0`, `Community 4`, `Community 38`, `Community 39`, `Community 8`, `Community 43`, `Community 44`, `Community 46`, `Community 20`, `Community 53`, `Community 54`, `Community 23`, `Community 56`, `Community 57`, `Community 28`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `$lib/utils.js` connect `Community 22` to `Community 37`, `Community 5`, `Community 14`, `Community 17`, `Community 27`, `Community 60`, `Community 61`?**
