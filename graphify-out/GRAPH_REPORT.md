...
## Corpus Check
- 400 files · ~166,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1777 nodes · 3474 edges · 123 communities (101 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e194bd2c`
...
Cohesion: 0.13
Nodes (25): @lucide/svelte/icons/alert-circle, @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/api/shifts, $lib/components/ui, $lib/components/ui/dropdown-menu/index.js, $lib/constants (+17 more)
...
Cohesion: 0.18
Nodes (11): $lib/components, $lib/stores/navigationGuard, $lib/utils/employeeValidationHelper, $lib/utils/errors.js, $lib/components/common/AsyncDropdown.svelte, $lib/components/employee/EmployeeWizard.svelte, $app/navigation, svelte/reactivity (+3 more)
...
Cohesion: 0.12
Nodes (8): @lucide/svelte/icons/alert-triangle, $lib/components/index.js, $lib/confirmation.svelte.js, $lib/components/common/ConfirmModal.svelte, ./FilterDropdown.svelte, modalStack, stack, @lucide/svelte/icons/more-vertical
...
Cohesion: 0.13
Nodes (23): uploadPayroll(), POST(), DEDUCTION_KEYS, GROSS_KEYS, IDENTITY_KEYS, MONTH_KEYS, MONTH_NAMES, NAME_KEYS (+15 more)
...
Cohesion: 0.19
Nodes (11): serializePayroll(), serializePayrollList(), computeSummary(), DuplicatePayrollError, extractPaidDays(), fetchEmployeeDetails(), getPayrollByCuid(), getPayrolls() (+3 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (20): $lib/components/ui/checkbox/index.js, $lib/components/ui/scroll-area/index.js, $lib/master-data/master-config, $lib/permissions/mock-permissions, @lucide/svelte/icons/chevron-up, backendError, displayOptions, errorMessage (+12 more)
...
Cohesion: 0.13
Nodes (8): serializePayrollUploadFailureList(), serializePayrollUpload(), serializePayrollUploadList(), getPayrollUploadByCuid(), getPayrollUploadFailures(), getPayrollUploads(), PayrollUploadNotFoundError, PayrollUpload
...
Cohesion: 0.29
Nodes (9): sendDeleted(), sendUpdated(), DELETE(), parseCuid(), PUT(), DELETE(), parseCuid(), PATCH() (+1 more)
...
Cohesion: 0.15
Nodes (11): load(), CreateRevisionDto, CreateSalaryStructureDto, CreateSalaryStructureItemDto, DeleteSalaryStructureResponse, ListSalaryStructureResponse, MutationSalaryStructureResponse, SalaryStructure (+3 more)
...
Cohesion: 0.13
Nodes (9): @lucide/svelte/icons/arrow-left, $lib/server/serializers/salary-component.serializer, $lib/toast.svelte, $lib/types/salary-structure, $lib/validators/salary-structure, @internationalized/date, $app/paths, @lucide/svelte/icons/plus (+1 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (5): bankDetailSchema, personalSchema, skillSchema, UpsertBankDetailDto, UpsertSkillDto
...
Cohesion: 0.16
Nodes (13): $lib/api/local, $lib/api/locations, $lib/types/organization_location, $lib/utils, @lucide/svelte/icons/check, $lib/components/common/SimpleMasterModal.svelte, activeCount, confirmDelete() (+5 more)
...
Cohesion: 0.19
Nodes (8): UpsertSkillInput, createEmployee(), CreateEmployeeDto, deleteEmployee(), generateNextEmployeeCode(), toPublicEmployee(), updateEmployee(), UpdateEmployeeDto
...
Cohesion: 0.70
Nodes (4): DELETE(), parseCuid(), PATCH(), PUT()
...
Cohesion: 0.13
Nodes (9): UpsertBankDetailInput, EmployeeOption, findEmployeeByCode(), getAll(), MOCK_EMPLOYEES, MockEmployee, toOption(), PayrollNotFoundError (+1 more)
...
## Knowledge Gaps
- **403 isolated node(s):** `css.lint.unknownAtRules`, `$schema`, `css`, `baseColor`, `components` (+398 more)
...
- **Why does `$lib/utils.js` connect `Community 16` to `Community 4`, `Community 11`, `Community 45`, `Community 14`, `Community 53`, `Community 58`, `Community 62`, `Community 127`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `db` connect `Community 30` to `Community 1`, `Community 2`, `Community 3`, `Community 8`, `Community 25`, `Community 33`, `Community 36`, `Community 39`, `Community 42`, `Community 43`, `Community 47`, `Community 51`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 59`, `Community 64`, `Community 71`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 80`, `Community 85`, `Community 96`, `Community 123`?**
