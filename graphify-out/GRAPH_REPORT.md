...
## Corpus Check
- 347 files · ~117,512 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1375 nodes · 2558 edges · 102 communities (70 shown, 32 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c7902272`
...
6. `$lib/components/employee/EmployeeWizard.svelte` - 19 edges
7. `pieq-svelte-app-template` - 18 edges
8. `successResponse()` - 16 edges
9. `scripts` - 15 edges
10. `$lib/components/common/DesignationDropdown.svelte` - 15 edges
...
Cohesion: 0.07
Nodes (68): GET(), POST(), GET(), POST(), createSuccessResponse(), deleteSuccessResponse(), EmploymentTypeDTO, EmploymentTypeInput (+60 more)
...
Cohesion: 0.07
Nodes (22): RoleListResponse, sendDeleted(), sendUpdated(), DELETE(), parseCuid(), PATCH(), PUT(), DELETE() (+14 more)
...
Cohesion: 0.09
Nodes (21): @lucide/svelte/icons/alert-triangle, $lib/components/index.js, $lib/components/ui, $lib/components/ui/dropdown-menu/index.js, $lib/confirmation.svelte.js, $lib/validators/employment-type.js, ./$types, ./$types.js (+13 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (22): AddressData, BankData, DocumentData, EducationData, EmploymentDetailsData, ExperienceData, LanguageData, PersonalDetailsData (+14 more)
...
Cohesion: 0.19
Nodes (17): @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/api/local, $lib/api/locations, $lib/api/roles, $lib/api/shifts, $lib/stores/navigationGuard (+9 more)
...
Cohesion: 0.17
Nodes (10): @lucide/svelte/icons/arrow-left, $lib/components, $lib/utils/employeeValidationHelper, ./$types, $lib/components/common/ConfirmModal.svelte, $lib/components/common/DepartmentDropdown.svelte, $lib/components/employee/EmployeeWizard.svelte, svelte/reactivity (+2 more)
...
Cohesion: 0.16
Nodes (5): createClient(), db, getDb(), isValidClient(), mapState()
...
Cohesion: 0.13
Nodes (14): $lib/components/ui/checkbox/index.js, $lib/constants, $lib/master-data/master-config, $lib/permissions/mock-permissions, @lucide/svelte/icons/chevron-up, $lib/components/common/DesignationDropdown.svelte, backendError, errorMessage (+6 more)
...
Cohesion: 0.13
Nodes (6): mapCountry(), mapLocation(), mapRole(), mapShift(), sendCreated(), sendList()
...
Cohesion: 0.28
Nodes (9): ./$types, load(), load(), getDepartments(), getDesignations(), listLocations(), listRoles(), CreateLoadResult (+1 more)
...
Cohesion: 0.27
Nodes (8): createEmployee(), CreateEmployeeDto, deleteEmployee(), generateNextEmployeeCode(), getEmployeeByCuid2(), toPublicEmployee(), updateEmployee(), UpdateEmployeeDto
...
## Knowledge Gaps
- **314 isolated node(s):** `css.lint.unknownAtRules`, `$schema`, `css`, `baseColor`, `components` (+309 more)
...
- **Why does `db` connect `Community 20` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 23`, `Community 26`, `Community 28`, `Community 32`, `Community 33`, `Community 38`, `Community 39`, `Community 46`, `Community 47`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 79`?**
