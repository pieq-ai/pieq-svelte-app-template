...
## Corpus Check
- 264 files · ~69,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1070 nodes · 1864 edges · 75 communities (47 shown, 28 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d721ca1c`
...
3. `mapToDb()` - 29 edges
4. `db` - 26 edges
5. `$lib/components/employee/EmployeeWizard.svelte` - 19 edges
6. `sendUpdated()` - 19 edges
7. `$lib/components/common/DepartmentDropdown.svelte` - 18 edges
8. `$lib/components/common/DesignationDropdown.svelte` - 18 edges
...
- `GET()` --calls--> `toDepartmentDTO()`  [INFERRED]
  src/routes/api/departments/[cuid]/+server.ts → src/lib/server/utils/mapping.ts
- `GET()` --calls--> `toDesignationDTO()`  [INFERRED]
  src/routes/api/designations/[cuid]/+server.ts → src/lib/server/utils/mapping.ts
...
Cohesion: 0.07
Nodes (41): load(), getMaster(), POST(), POST(), GET(), getMaster(), getStatus(), POST() (+33 more)
...
Cohesion: 0.11
Nodes (30): GET(), PUT(), GET(), PUT(), GET(), PUT(), GET(), PUT() (+22 more)
...
Cohesion: 0.07
Nodes (36): ./$types, load(), MasterCreateInput, MasterUpdateInput, getMasterConfig(), isMasterKey(), MasterConfig, masterConfigs (+28 more)
...
Cohesion: 0.10
Nodes (15): $lib/components, $lib/components/index.js, $lib/components/ui/checkbox/index.js, $lib/components/ui/dropdown-menu/index.js, @lucide/svelte/icons/check, @lucide/svelte/icons/chevron-left, @lucide/svelte/icons/chevron-right, @lucide/svelte/icons/chevron-up (+7 more)
...
Cohesion: 0.08
Nodes (8): dateErrors, defaultEmp, emp, errors, hasErrors, isDirty, isTouched, originalData

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (30): $lib/components/common/DepartmentDropdown.svelte, backendError, errorMessage, getValidationError(), inputValue, isLoading, isModalOpen, isSubmitting (+22 more)

### Community 51 - "Community 51"
Cohesion: 0.25
Nodes (4): $lib/components/ui/popover/index.js, $lib/components/ui/scroll-area/index.js, @lucide/svelte/icons/chevron-down, @internationalized/date
...
Cohesion: 0.21
Nodes (11): @lucide/svelte/icons/arrow-left, $lib/utils/employeeValidationHelper, ./$types, @lucide/svelte/icons/edit, $lib/components/employee/EmployeeWizard.svelte, $app/navigation, @lucide/svelte/icons/plus, svelte/reactivity (+3 more)
...
Cohesion: 0.27
Nodes (8): GET(), getErrorStatus(), POST(), EmployeeValidationError, listEmployees(), mockedDao, sampleEmployee, sendCreated()
...
## Knowledge Gaps
- **299 isolated node(s):** `css.lint.unknownAtRules`, `$schema`, `css`, `baseColor`, `components` (+294 more)
...
- **Why does `db` connect `Community 64` to `API Endpoints`, `Data Access Tests`, `Community 35`, `Community 36`, `Community 67`, `Community 70`, `Community 39`, `Community 38`, `Department Service DAO`, `Community 44`, `Community 47`, `Community 52`, `Community 53`, `Community 55`, `Community 62`, `Community 63`?**
