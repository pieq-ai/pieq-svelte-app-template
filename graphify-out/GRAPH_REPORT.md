...
## Corpus Check
- 399 files · ~172,926 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1903 nodes · 3761 edges · 137 communities (115 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ddaf33ea`
...
10. `$lib/components/organization_locations/LocationModal.svelte` - 19 edges
...
Cohesion: 0.08
Nodes (39): @lucide/svelte/icons/alert-circle, @lucide/svelte/icons/alert-triangle, @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/api/leaves, $lib/api/shifts, $lib/components/index.js (+31 more)

### Community 2 - "UI Components Index"
Cohesion: 0.10
Nodes (23): $lib/components, $lib/constants, $lib/permissions/mock-permissions, $lib/toast, $lib/types/salary-component, $lib/utils, $lib/validators/salary-component, $lib/components/ui/checkbox/index.js (+15 more)
...
Cohesion: 0.12
Nodes (11): create(), createAttendanceSource(), MasterCreateInput, MasterUpdateInput, MasterConfig, masterConfigs, MasterKey, masterKeys (+3 more)
...
Cohesion: 0.05
Nodes (39): ShiftCreatePayload, ShiftListResponse, ShiftUpdatePayload, ./$types, create(), findByCuid(), listForSubordinates(), resolveRelations() (+31 more)

### Community 11 - "Server Authentication"
Cohesion: 0.21
Nodes (17): accrueLeaves(), applyLeaveByCuid(), ApplyLeaveInput, calculateFractionalMonths(), getAvailableBalanceForMonth(), getBusinessDate(), getDaysInMonth(), getEmployeeLeaveDetails() (+9 more)
...
Cohesion: 0.18
Nodes (11): ./$types, GET(), GET(), POST(), GET(), POST(), mapShift(), sendCreated() (+3 more)
...
Cohesion: 0.23
Nodes (16): POST(), POST(), PUT(), GET(), POST(), POST(), errorResponse(), trimStringFields() (+8 more)

### Community 19 - "Mock Permissions"
Cohesion: 0.06
Nodes (22): $lib/api/local, $lib/api/locations, $lib/toast, $lib/types/organization_location, $lib/utils, $lib/components/common/SimpleMasterModal.svelte, activeCount, confirmDelete() (+14 more)
...
Cohesion: 0.13
Nodes (20): GET(), createSuccessResponse(), EmploymentTypeDTO, EmploymentTypeInput, HolidayDTO, HolidayInput, LeavePolicyDTO, LeavePolicyInput (+12 more)
...
Cohesion: 0.19
Nodes (7): ApplyLeavePayload, leavesApi, extractErrorMessage(), localApi, localRequest(), RoleListResponse, Role
...
Cohesion: 0.18
Nodes (10): GET(), PUT(), GET(), PUT(), serialize(), toDepartmentDTO(), toDesignationDTO(), toEmployeeAttendanceViewDTO() (+2 more)

### Community 58 - "Community 58"
Cohesion: 0.09
Nodes (17): $lib/api/shift-assignments, $lib/types/shift-assignment, activeCount, backendEffectiveFromError, backendEffectiveToError, backendEmployeeError, backendShiftError, effectiveFromError (+9 more)
...
Cohesion: 0.20
Nodes (13): ./$types, ./$types, load(), load(), mapLocation(), getDepartments(), getDesignations(), getEmployeeByCuid2() (+5 more)
...
Cohesion: 0.15
Nodes (17): deleteSuccessResponse(), formatHoliday(), createHoliday(), CreateHolidayInput, deleteHoliday(), getHolidayByCuid(), HolidayMultiValidationError, HolidayValidationError (+9 more)

### Community 66 - "Community 66"
Cohesion: 0.26
Nodes (9): calculateDistance(), GEOFENCE_CONFIG, AttendanceMultiValidationError, checkIn(), checkOut(), getEmployeeHistory(), getOrCreateWebSource(), getTodayStatus() (+1 more)

### Community 67 - "Community 67"
Cohesion: 0.16
Nodes (6): POST(), GET(), getMaster(), getStatus(), POST(), ValidationError
...
Cohesion: 0.14
Nodes (11): $lib/components/ui/calendar/index.js, $lib/components/ui/input/index.js, $lib/components/ui/popover/index.js, $lib/components/ui/scroll-area/index.js, autoFormatDate(), currentYear, handleBlur(), handleInput() (+3 more)
...
Cohesion: 0.30
Nodes (14): getMasterConfig(), isMasterKey(), createMasterData(), ensureUnique(), getCountries(), getStates(), MasterDataDto, normalizeName() (+6 more)
...
Cohesion: 0.24
Nodes (9): getMaster(), POST(), GET(), getErrorStatus(), POST(), getStatus(), PUT(), mapToDb() (+1 more)

### Community 81 - "Community 81"
Cohesion: 0.14
Nodes (4): UpsertExperienceInput, experienceSchema, personalSchema, UpsertExperienceDto

### Community 82 - "Community 82"
Cohesion: 0.15
Nodes (11): ApiError, $app/environment, toast, createDirtyChecker(), WithElementRef, WithoutChild, WithoutChildren, WithoutChildrenOrChild (+3 more)
...
Cohesion: 0.47
Nodes (9): calculateLeaveDays(), isHoliday(), isWeekend(), PUBLIC_HOLIDAYS_2026, toLocalDateString(), toUtcDateString(), applyLeave(), _applyLeaveCore() (+1 more)
...
Cohesion: 0.29
Nodes (4): ./$types, mapCountry(), mapState(), GET()
...
## Knowledge Gaps
- **483 isolated node(s):** `$schema`, `css`, `baseColor`, `components`, `utils` (+478 more)
...
- **Why does `db` connect `Community 122` to `Community 133`, `Master Data DAO`, `Department Service DAO`, `Designation Service DAO`, `Server Authentication`, `Permission Service`, `Community 35`, `Community 36`, `Community 53`, `Community 54`, `Community 67`, `Community 68`, `Community 69`, `Community 70`, `Community 72`, `Community 73`, `Community 77`, `Community 81`, `Community 83`, `Community 85`, `Community 90`, `Community 98`, `Community 102`, `Community 104`, `Community 106`, `Community 107`, `Community 116`, `Community 117`, `Community 118`, `Community 119`, `Community 125`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `$lib/utils.js` connect `Community 59` to `Community 1`, `UI Components Index`, `UI Components Core`, `Community 74`, `Community 56`, `Community 89`, `Community 61`?**
