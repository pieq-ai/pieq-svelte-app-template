...
## Summary
- 1303 nodes · 2468 edges · 103 communities (88 shown, 15 thin omitted)
...
Cohesion: 0.18
Nodes (10): POST(), POST(), GET(), PUT(), GET(), PUT(), ValidationError, mapToDb() (+2 more)
...
Cohesion: 0.17
Nodes (18): GET(), deleteSuccessResponse(), successResponse(), AttendanceMultiValidationError, AttendanceValidationError, checkOut(), createAttendanceRecord(), CreateAttendanceRecordDto (+10 more)
...
Cohesion: 0.16
Nodes (16): formatHoliday(), createHoliday(), CreateHolidayInput, deleteHoliday(), getHolidayByCuid(), HolidayMultiValidationError, HolidayValidationError, updateHoliday() (+8 more)
...
Cohesion: 0.22
Nodes (13): actions, load(), GET(), getErrorStatus(), POST(), createEmployee(), CreateEmployeeInput, EmployeeValidationError (+5 more)

### Community 35 - "Community 35"
Cohesion: 0.15
Nodes (15): EmploymentTypeDTO, EmploymentTypeInput, formatLeavePolicy(), HolidayDTO, HolidayInput, LeavePolicyDTO, LeavePolicyInput, LeaveTypeDTO (+7 more)
...
Cohesion: 0.22
Nodes (11): GET(), getStatus(), POST(), DELETE(), GET(), getStatus(), PUT(), toEmployeeDTO() (+3 more)

### Community 38 - "Community 38"
Cohesion: 0.15
Nodes (13): POST(), @sveltejs/kit, calculateDistance(), GEOFENCE_CONFIG, checkIn(), AttendanceMultiValidationError, AttendanceValidationError, checkIn() (+5 more)
...
Cohesion: 0.15
Nodes (15): GET(), GET(), POST(), GET(), POST(), mapCountry(), mapLocation(), mapRole() (+7 more)
...
Cohesion: 0.12
Nodes (23): GET(), formatLeaveType(), createLeavePolicy(), CreateLeavePolicyInput, deleteLeavePolicy(), listLeavePolicies(), UpdateLeavePolicyInput, validateAndMapPolicyInput() (+15 more)
...
Cohesion: 0.30
Nodes (16): POST(), POST(), PUT(), GET(), POST(), POST(), createSuccessResponse(), errorResponse() (+8 more)
...
Cohesion: 0.11
Nodes (11): @lucide/svelte/icons/alert-triangle, $lib/components, $lib/components, $lib/confirmation.svelte.js, @lucide/svelte/icons/chevron-left, @lucide/svelte/icons/chevron-right, modalStack, stack (+3 more)
...
- **Why does `db` connect `Data Access Tests` to `Master Data DAO`, `Department Service DAO`, `Permission Service`, `Community 36`, `Community 38`, `Community 40`, `Community 46`, `Community 47`, `Community 54`, `Community 57`, `Community 60`, `Community 82`, `Community 83`, `Community 84`, `Community 87`, `Community 88`, `Community 90`, `Community 91`, `Community 92`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `$lib/utils.js` connect `UI Components Core` to `Community 81`, `Designation Service DAO`, `System Role Service`?**
