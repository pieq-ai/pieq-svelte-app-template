...
## Corpus Check
- 142 files · ~37,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 571 nodes · 988 edges · 47 communities (32 shown, 15 thin omitted)
...
Cohesion: 0.09
Nodes (7): CreateLeavePolicyData, update(), CreateLeaveTypeData, update(), createClient(), getDb(), isValidClient()

### Community 2 - "Core UI Components"
Cohesion: 0.06
Nodes (13): $lib/components/index.js, $lib/components/ui/dropdown-menu/index.js, $lib/utils.js, @lucide/svelte/icons/check, @lucide/svelte/icons/chevron-down, @lucide/svelte/icons/chevron-left, @lucide/svelte/icons/chevron-right, svelte/elements (+5 more)
...
Cohesion: 0.05
Nodes (35): @lucide/svelte/icons/circle-check, @lucide/svelte/icons/info, @lucide/svelte/icons/loader-2, @lucide/svelte/icons/octagon-x, devDependencies, clsx, dotenv-cli, eslint (+27 more)

### Community 6 - "Holiday Data Access (DAO)"
Cohesion: 0.10
Nodes (13): CreateHolidayData, createHoliday(), CreateHolidayInput, deleteHoliday(), HolidayValidationError, listHolidays(), updateHoliday(), UpdateHolidayInput (+5 more)
...
Cohesion: 0.22
Nodes (7): $lib/assets/favicon.svg, $lib/auth, $lib/components/layout, ./layout.css, $app/navigation, svelte-sonner, $app/paths

### Community 12 - "Leave Policy Management UI & Navigation"
Cohesion: 0.20
Nodes (5): ./$types.js, toggleMenu(), updateMenuPosition(), @lucide/svelte/icons/search, @lucide/svelte/icons/x
...
Cohesion: 0.22
Nodes (7): @lucide/svelte/icons/calendar, @lucide/svelte/icons/calendar-cog, @lucide/svelte/icons/layout-dashboard, @lucide/svelte/icons/log-out, @lucide/svelte/icons/settings, @lucide/svelte/icons/shield-check, svelte/transition

### Community 15 - "Holiday Calendar UI & Navigation"
Cohesion: 0.22
Nodes (5): ./$types, @lucide/svelte/icons/ellipsis-vertical, Holiday, @lucide/svelte/icons/loader-circle, svelte/reactivity
...
Cohesion: 0.22
Nodes (7): $lib/components, $lib/components/ui, $lib/master-data/master-config, $lib/permissions/mock-permissions, @lucide/svelte/icons/more-vertical, @lucide/svelte/icons/pencil, @lucide/svelte/icons/plus

## Knowledge Gaps
- **198 isolated node(s):** `css.lint.unknownAtRules`, `$schema`, `css`, `baseColor`, `components` (+193 more)
...
- **Why does `devDependencies` connect `Development & Build Tools` to `Core UI Components`, `Core Dependency Layer`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Core Dependency Layer` to `Static Assets and Library Routes`?**
...
- **Should `API Routes and Server Handlers` be split into smaller, more focused modules?**
  _Cohesion score 0.08605851979345955 - nodes in this community are weakly interconnected._
