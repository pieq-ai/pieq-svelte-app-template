...
## Corpus Check
- 236 files · ~94,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1133 nodes · 1883 edges · 61 communities (50 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7708bffc`
...
Cohesion: 0.09
Nodes (18): @lucide/svelte/icons/alert-circle, $lib/api/leaves, $lib/api/local, $lib/api/locations, $lib/components/index.js, $lib/components/ui/dropdown-menu/index.js, $lib/types/organization_location, @lucide/svelte/icons/calendar (+10 more)
...
Cohesion: 0.15
Nodes (10): @lucide/svelte/icons/alert-triangle, $lib/components, $lib/components, $lib/confirmation.svelte.js, @lucide/svelte/icons/chevron-left, @lucide/svelte/icons/more-vertical, @lucide/svelte/icons/pencil, @lucide/svelte/icons/search (+2 more)
...
Cohesion: 0.10
Nodes (16): averageAge, filteredEmployees, formError, handleAddEmployee(), isSubmitting, loadEmployees(), maxAge, successMessage (+8 more)
...
Cohesion: 0.14
Nodes (23): ./$types, calculateLeaveDays(), isHoliday(), isWeekend(), PUBLIC_HOLIDAYS_2026, toLocalDateString(), POST(), accrueLeaves() (+15 more)
...
- **Why does `db` connect `Community 59` to `API Endpoints`, `Community 35`, `Community 36`, `Master Data DAO`, `Community 39`, `Community 40`, `Department Service DAO`, `Designation Service DAO`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 54`, `Community 57`, `Community 58`?**
