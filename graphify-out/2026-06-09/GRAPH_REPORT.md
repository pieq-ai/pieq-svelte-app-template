...
## Corpus Check
- 194 files · ~53,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1006 nodes · 1573 edges · 55 communities (43 shown, 12 thin omitted)
...
Cohesion: 0.06
Nodes (50): @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/components, $lib/components/index.js, $lib/components/ui/dropdown-menu/index.js, $lib/constants, $lib/master-data/master-config (+42 more)
...
Cohesion: 0.08
Nodes (24): @lucide/svelte/icons/building-2, $lib/assets/favicon.svg, $lib/auth, ./layout.css, $lib/assets/favicon.svg, $lib/auth, ./layout.css, $app/environment (+16 more)
...
Cohesion: 0.07
Nodes (28): findItemsByStructureCuid(), findItemsByStructureCuids(), findMany(), findEmployeeByCuid(), MOCK_EMPLOYEES, MockEmployee, serializeSalaryStructure(), assertComponentsValid() (+20 more)
