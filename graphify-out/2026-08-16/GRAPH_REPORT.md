# Graph Report - pieq-svelte-app-template  (2026-08-16)

## Corpus Check
- 232 files · ~87,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1112 nodes · 1839 edges · 56 communities (43 shown, 13 thin omitted)
...
Cohesion: 0.17
Nodes (8): calculateAge(), create(), CreateEmployeeData, EmployeeCompatibility, createClient(), db, getDb(), isValidClient()

### Community 2 - "UI Components Index"
Cohesion: 0.06
Nodes (57): @lucide/svelte/icons/alert-circle, @lucide/svelte/icons/alert-triangle, @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/components, $lib/constants, $lib/master-data/master-config (+49 more)
...
- **Why does `db` connect `Data Access Tests` to `API Endpoints`, `Community 36`, `Master Data DAO`, `Community 37`, `Community 39`, `Community 38`, `Department Service DAO`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 54`, `Community 56`?**
