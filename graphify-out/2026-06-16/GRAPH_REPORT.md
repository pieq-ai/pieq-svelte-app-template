...
## Corpus Check
- 231 files · ~89,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1111 nodes · 1836 edges · 56 communities (44 shown, 12 thin omitted)
...
Cohesion: 0.06
Nodes (59): @lucide/svelte/icons/alert-circle, @lucide/svelte/icons/alert-triangle, @lucide/svelte/icons/arrow-down, @lucide/svelte/icons/arrow-up, @lucide/svelte/icons/arrow-up-down, $lib/components, $lib/constants, $lib/master-data/master-config (+51 more)
...
Cohesion: 0.07
Nodes (30): @lucide/svelte/icons/building-2, $lib/assets/favicon.svg, $lib/auth, ./layout.css, $lib/assets/favicon.svg, $lib/auth, ./layout.css, @lucide/svelte/icons/calendar (+22 more)
...
Cohesion: 0.15
Nodes (17): calculateAge(), create(), CreateEmployeeData, EmployeeCompatibility, actions, load(), GET(), getErrorStatus() (+9 more)
...
Cohesion: 0.17
Nodes (20): calculateLeaveDays(), isHoliday(), isWeekend(), PUBLIC_HOLIDAYS_2026, toLocalDateString(), POST(), accrueLeaves(), applyLeave() (+12 more)
...
- **Why does `db` connect `Community 59` to `API Endpoints`, `Data Access Tests`, `Community 34`, `Community 35`, `Community 36`, `Master Data DAO`, `Community 38`, `Community 39`, `Department Service DAO`, `Community 44`, `Permission Service`, `Community 46`, `Community 47`, `Community 48`, `Community 54`?**
