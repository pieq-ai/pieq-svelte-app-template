...
*/
-- AlterTable
ALTER TABLE "countries" ADD COLUMN     "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "created_by" VARCHAR(100),
ADD COLUMN     "updated_at" TIMESTAMPTZ NOT NULL,
ADD COLUMN     "updated_by" VARCHAR(100);

-- AlterTable
ALTER TABLE "states" ADD COLUMN     "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "created_by" VARCHAR(100),
ADD COLUMN     "updated_at" TIMESTAMPTZ NOT NULL,
ADD COLUMN     "updated_by" VARCHAR(100),
ALTER COLUMN "country_cuid" SET DATA TYPE TEXT;
