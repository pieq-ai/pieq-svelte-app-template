/*
  ...
  - The primary key for the `holiday_calendars` table will be changed. If it partially fails, the table could be left without primary key constraint.
  ...
  - The primary key for the `leave_policies` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - The primary key for the `leave_policy_employment_types` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "holiday_calendars" DROP CONSTRAINT "holiday_calendars_pkey",
ALTER COLUMN "id" SET DATA TYPE bigint,
...
-- AlterTable
ALTER TABLE "leave_policy_employment_types" DROP CONSTRAINT "leave_policy_employment_types_pkey",
ALTER COLUMN "id" SET DATA TYPE bigint,
ADD CONSTRAINT "leave_policy_employment_types_pkey" PRIMARY KEY ("id");
